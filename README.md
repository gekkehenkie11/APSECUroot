...
Explanation: the updater will extract the contents to the /tmp directory and it then executes /tmp/update_localweb/assist, which was replaced with a script to change your root password
